...
<footer id="footer" class="bg-primary">
  <div class="row">
    <div class="col-12 " style="text-align: left;">
      <h4>Case Study - Module 3 - C0724M1</h4>
  ...
  <div class="m-auto">
    <div class="row">
      <div class="col-4">
        <p class="clear-p">Trần Giang Đại Hoàng</p>
        <p class="clear-p">Nguyễn Đức Hiếu</p>
        <p class="clear-p">Lê Hồng Phúc</p>
        <p class="clear-p">Nguyễn Tuấn Anh</p>
      </div>
      <div class="col-4 text-center">
        <p class="clear-p">daihoangktv@gmail.com</p>
        <p class="clear-p">hieuducnguyen2004@gmail.com</p>
        <p class="clear-p">phucle.230103@gmail.com</p>
        <p class="clear-p">gundogan189@gmail.com</p>
      </div>
      <div class="col-4 text-right">
        <p class="clear-p">C0724M1-JV103</p>
        <p class="clear-p">C0324M4-JV103</p>
        <p class="clear-p">C0324M4-JV103</p>
        <p class="clear-p">C0724M1-JV103</p>
      </div>
    </div>
